                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="product-item-close">
                                        <a href="edit_category.php?category_id=<?php echo $row['category_id']; ?>" class="ti-close"></a>
                                    </td>
                                    <td class="product-item-close">
                                        <a href="delete_category.php?category_id=<?php echo $row['category_id']; ?>" class="ti-close"></a>
                                    </td>
                                </tr>
                                <?php
                                    }
