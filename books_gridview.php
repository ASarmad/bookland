		...
		<div class="container">
			...
			<div class="row book-grid-row">
				...
				if(isset($_GET['cid']))
				{
					...
					$sql = "SELECT * FROM book WHERE book_category_id = $category_id";
				}
				else
				{
							...
							<div class="col-book style-1">
								<div class="dz-shop-card style-1">
									...
									<div class="dz-content">
										<h5 class="title"><a href="books_details.php?bid=<?php echo $category_id; ?>"><?php echo $row['book_name']; ?></a></h5>	
										<div class="book-footer">
											<div class="price">
												<span class="price-num"><?php echo $row['book_price']; ?>$</span>
											</div>
											<a href="shop_cart.php?bid=<?php echo $category_id; ?>" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
										</div>
									</div>
								</div>
							</div>	
